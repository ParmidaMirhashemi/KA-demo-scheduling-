...
if __name__ == '__main__':
    ...
    beta = {(p, t): (p /np.log(t+2)) for p in P for t in T}
    ...
    Delta = d
    alpha = {(p, j): (20 * (Delta[p] + p/10) + 1 - 20 * j) * (Delta[p] >= j) for p in P for j in range(1, delta)}
